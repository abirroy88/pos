...
<div class="box">
    <div class="box-header">
        <h3 class="box-title">Due Invoices</h3>                                    
    </div><!-- /.box-header -->
    <div class="box-body table-responsive">
        <table id="example1" class="table table-bordered table-striped">
            ...
            <tbody>
                <?php
                $sl = 1;
                foreach ($querydueinvoice as $dueinvoice) {
                    ...
                    if ($dueinvoice->due_amount == 0 || $dif > 30) {
                        ...
                        <tr>
                            ...
                            <td><a href="<?php echo base_url(); ?>billingcontroller/addpaymentbyviewdueinvoice/<?php echo $dueinvoice->invoice_id; ?>" class="btn btn-success  btn-xs btn-flat">Add Payment</a> </td>
                        </tr>
                        <?php
                    } }
                    $sl++;
