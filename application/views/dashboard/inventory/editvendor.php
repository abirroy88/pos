...
<div class="row">
    <div class="col-sm-12">
        ...
        <div class="card-box table-responsive" style="min-height: 500px">
            <form action="<?php echo base_url(); ?>inventory/updatevendor/<?php echo $editvendor->id; ?>" id="addForm" name="addForm" method="post" accept-charset="utf-8">
                <h4 class="m-t-0 header-title">
                    ...
                    <div class="input-group pull-right text-right m-b-0" style="padding-bottom: 10px">
                        ...
                        <button id="submit" class="btn btn-primary waves-effect waves-light  btn-xs" type="submit">Update
                        </button>
                        <a href="<?php echo base_url(); ?>inventory/deletevendor/<?php echo $editvendor->id; ?>" class="btn btn-danger waves-effect waves-light m-l-5  btn-xs">
                            Delete
                        </a>
                    </div>
                </h4>
                ...
                <div class="row">
                    <div class="col-lg-6 text-left ">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" id="name" name="name" placeholder="Name" class="form-control input-sm" value="<?php echo $editvendor->name; ?>">
                        </div>
                        <div class="input-group">
                            <span class="input-group-addon">Phone</span>
                            <input type="text" id="phone" name="phone" placeholder="Phone" class="form-control input-sm" value="<?php echo $editvendor->phone; ?>">
                        </div>

                        <div class="input-group">
                            <span class="input-group-addon">Mobile</span>
                            <input type="text" id="mobile" name="mobile" placeholder="Mobile number" class="form-control input-sm" value="<?php echo $editvendor->mobile; ?>">
                        </div>
                        <div class="input-group">
                            <span class="input-group-addon">Email</span>
                            <input type="email" id="email" name="email" placeholder="Email address" class="form-control input-sm" value="<?php echo $editvendor->email; ?>">
                        </div>

                        <div class="input-group">
                            <span class="input-group-addon">Website</span>
                            <input type="url" id="website" name="website" placeholder="website" class="form-control input-sm" value="<?php echo $editvendor->website; ?>">
                        </div>

                        <label class="control-label" style="padding-top: 10px">Accounts</label>

                        <div class="input-group">
                            <span class="input-group-addon">Bank Nmae</span>
                            <input type="text" id="bank_name" name="bank_name" placeholder="name" class="form-control input-sm" value="<?php echo $editvendor->name; ?>">
                        </div>

                        <div class="input-group">
                            <span class="input-group-addon">Bank A/C</span>
                            <input type="text" id="bank_ac_no" name="bank_ac_no" placeholder="Enter bank account number" class="form-control input-sm" value="<?php echo $editvendor->bank_ac_no; ?>">
                        </div>

                        <div class="input-group">
                            <span class="input-group-addon">Paypal</span>
                            <input type="text" id="paypal" name="paypal" placeholder="Paypal" class="form-control input-sm" value="<?php echo $editvendor->paypal; ?>">
                        </div>

                        <div class="input-group">
                            <span class="input-group-addon">Skrill</span>
                            <input type="text" id="skrill" name="skrill" placeholder="Skrill" class="form-control input-sm" value="<?php echo $editvendor->skrill; ?>">
                        </div>

                        <div class="input-group">
                            <span class="input-group-addon">Payza</span>
                            <input type="text" id="payza" name="payza" placeholder="Payza" class="form-control input-sm" value="<?php echo $editvendor->payza; ?>">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 text-left">
                        ...
                        <div class="input-group">
                            <span class="input-group-addon">Name</span>
                            <input type="text" id="person_name" name="person_name" placeholder="Name" class="form-control input-sm" value="<?php echo $editvendor->contact_person_name; ?>">
                        </div>

                        <div class="input-group">
                            <span class="input-group-addon">Designation</span>
                            <input type="text" id="person_designation" name="person_designation" placeholder="Designation" class="form-control input-sm" value="<?php echo $editvendor->contact_person_designation; ?>">
                        </div>

                        <div class="input-group">
                            <span class="input-group-addon">Email</span>
                            <input type="email" id="person_email" name="person_email" placeholder="Email" class="form-control input-sm" value="<?php echo $editvendor->contact_person_email; ?>">
                        </div>

                        <div class="input-group">
                            <span class="input-group-addon">Phone</span>
                            <input type="text" id="person_phone" name="person_phone" placeholder="Phone" class="form-control input-sm" value="<?php echo $editvendor->contact_person_phone; ?>">
                        </div>

                        <div class="input-group">
                            <span class="input-group-addon">Mobile</span>
                            <input type="text" id="person_mobile" name="person_mobile" placeholder="Mobile number" class="form-control input-sm" value="<?php echo $editvendor->contact_person_mobile; ?>">
                        </div>

                        <label class="control-label" style="padding-top: 10px">Address</label>

                        <div class="input-group">
                            <span class="input-group-addon">Address  </span>
                            <input type="text" id="address" name="address" placeholder="Address" class="form-control input-sm" value="<?php echo $editvendor->address; ?>">
                        </div>

                        <div class="input-group">
                            <span class="input-group-addon">City</span>
                            <input type="text" id="city" name="city" placeholder="City" class="form-control input-sm" value="<?php echo $editvendor->city; ?>">
                        </div>

                        <div class="input-group">
                            <span class="input-group-addon">State</span>
                            <input type="text" id="state" name="state" placeholder="State" class="form-control input-sm" value="<?php echo $editvendor->state; ?>">
                        </div>

                        <div class="input-group">
                            <span class="input-group-addon">Zip</span>
                            <input type="text" id="zip" name="zip" placeholder="Sip code" class="form-control input-sm" value="<?php echo $editvendor->zip; ?>">
                        </div>
