...
<div class="col-md-6 col-md-offset-3">
    ...
    <div class="box box-primary">
        ...
        <!-- form start -->
        <form action="<?php echo base_url();?>expensecontroller/insertsubheadofexpense" method="post">
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <input name="sub_expense_id" type="text" readonly class="form-control" id="" placeholder="Sub Head of Expense ID" value="<?php echo "SHEX-".$randomSerialNUmber;?>">
                </div>
                <div class="form-group">
                    <label for="exampleInputPassword1">Sub Head of Expense Name <sup>*</sup></label>
                    <input name="sub_expense_name" type="" class="form-control" id="" placeholder="Sub Head of Expense Name">
                </div>
